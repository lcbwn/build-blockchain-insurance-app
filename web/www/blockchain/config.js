...
export const DEFAULT_CONTRACT_TYPES = [
  ...
  },
  {
    ...
    theftInsured: true,
    description: '优质零件换新服务',
    conditions: '仅适用于高级零件所有者.',
    minDurationDays: 10,
    maxDurationDays: 20,
    active: true
  },
  ...
  },
  {
    ...
    theftInsured: false,
    description: '万能换新服务',
    conditions: '通用合约条款在这里。 对于所有类型的商品.',
    minDurationDays: 1,
    maxDurationDays: 10,
    active: true
  }
